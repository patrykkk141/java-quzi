...
public class QuizQuestionService {
    ...
    List<QuizQuestion> generateRandomQuestions(int length, QuizType type, Quiz quiz, int answersQuantity) throws QuizException {
        ...
        throw new QuizException("Not enough question for this quiz settings. Please contact with administrator");
    }
